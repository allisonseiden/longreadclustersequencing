...
print(patient_2.trouble);
print(patient_2.unphased);
...
# patient_7.find_variants_for_phasing(5);
...
# patient_8.find_variants_for_phasing(5);
...
# patient_9.find_variants_for_phasing(5);
...
# patient_10.find_variants_for_phasing(5);
